...
| 1 product awaits configurator | ✅ Built (2026-05-30, reconciled 2026-06-17) | Marine Fitted Sheet (V-Berth) — hybrid configurator built: shape selector supports 14 shapes (01–14) with per-shape measurement diagrams/inputs and formula-based pricing. `calcVBerthFitted()` formula: width=max(HW,FW)+2D+14, length=L+2D+14, CloudSoft fabric only, VERTH_MARKUP=8.15. |
