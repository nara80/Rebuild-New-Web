...
function buildFixedPricingHTML(slug, p, prod) {
  ...
  if (slug === 'duvet-insert') {
    ...
    html += '<div class="panel-section"><div class="panel-label">Select Size</div><select class="size-select" id="duvet-size"><option value=""> — Choose size — </option><option value="single" data-thb="1290" data-usd="18">Single — 150×200cm · ฿1,290</option><option value="queen" data-thb="1490" data-usd="22">Queen — 200×230cm · ฿1,490</option><option value="king" data-thb="1690" data-usd="26">King — 230×250cm · ฿1,690</option></select></div>';
    html += '<div class="panel-section"><div class="panel-label">Fill Weight</div><select class="size-select" id="fill-weight"><option value=""> — Choose fill weight — </option><option value="light" data-mult="1.0">Light — 400 g/m² (summer)</option><option value="medium" data-mult="1.15" selected>Medium — 460 g/m² (all-season)</option><option value="heavy" data-mult="1.3">Heavy — 520 g/m² (winter)</option></select></div>';
