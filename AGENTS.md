...
| 2 — SEO URLs | ✅ Deployed | 271 rules via `public/_redirects` (258 WP URLs + 13 internal navigation) + `functions/product/` middleware redirect worker — deployed 2026-06-14 |
...
| 8 — Launch | 🏗️ In Progress | ✅ Deployed: robots.txt, security _headers, OG tags (homepage + product pages), OG image (/images/MildMate_OG.png), GTM+GA4 (GTM-KLJZZM9 + G-R2DDCBXXXX), https://www.mildmate.com/sitemap.xml built + submitted to Search Console, DNS cutover complete. ⏸ Pending: mobile QA, Lighthouse audit, Stripe live mode
